...
class Map:
    ...
    def load_assets(self):
        self.preview_image = pygame.transform.scale(pygame.image.load(asset_path(f"MAP{self.map_number}", "tile000.png")), MAP_DISPLAY_SIZE).convert_alpha()
